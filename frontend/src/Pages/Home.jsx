      ...
      <nav className="flex items-center justify-between p-4 mt-1 fixed top-0 left-0 right-0 z-35">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className="flex items-center px-4 py-2 rounded-3xl text-lg hover:bg-gray-800 hover:bg-opacity-55 transition-colors duration-300"
          >
          ...
          <button
            ...
            className="flex items-center px-4 py-2 rounded-3xl text-lg border border-opacity-50 border-white shadow-lg hover:bg-gray-800 hover:bg-opacity-55 transition-colors duration-300"
          >
